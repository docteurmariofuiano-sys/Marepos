 ...
 * Médecine Générale pour le Praticien, fiches dermato CESU — Drive source).
 *
...
window.MOTIFS = [
  ...
  },
  {
    ...
    urgences: [
      { l: "Abdomen aigu", f: "douleur_abdominale" }, { l: "Appendicite", f: "douleur_abdominale" }, { l: "Cholécystite", f: "douleur_abdominale" }, { l: "Pancréatite", b: "pancreatite_aigue" },
  ...
  },
  {
    ...
    frequents: [
      ...
      { l: "Infection urinaire récidivante", f: "cystite" }, { l: "Prostatite", f: "prostatite" }, { l: "Bilan rénal perturbé", b: "insuffisance_renale_chronique" },
      { l: "Œdèmes", f: "oedemes" }, { l: "Protéinurie", b: "insuffisance_renale_chronique" }, { l: "Sang dans le sperme", f: "hemospermie" }
    ],
    urgences: [
  ...
  },
  {
    ...
    frequents: [
      ...
      { l: "Cassure de la courbe / petite taille", f: "croissance_enfant" }, { l: "Puberté précoce ou retardée", f: "puberte_anormale" },
