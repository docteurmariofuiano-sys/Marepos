...
const APPS = [
  ...
  {t:"Formation Audio-Vestibulaire", e:"🎓", dom:"ORL",
   d:"Formation médicale complète et progressive sur les pathologies audio-vestibulaires : anatomie, imagerie, audiologie, vestibulogie, examen otoneurologique (HINTS, VPPB), explorations, rééducation, 30 cas cliniques, évaluations (QCM/QROC/OSCE) et 20 fiches mémo. Support de raisonnement, hors-ligne.",
   href:"formation-audio-vestibulaire/index.html"},
