...
const APPS = [
  ...
  {t:"Cotation MG", e:"💶", dom:"Transversal", soon:true,
   d:"Cotation des actes (NGAP/CCAM) — nécessite une base tarifaire Ameli sourcée et datée + disclaimer avant diffusion."},
  {t:"ALD renouvellement express", e:"🔄", dom:"Transversal", soon:true,
   d:"Renouvellement d'ALD (ordonnance bizone, protocole de soins) — application à fournir."},
