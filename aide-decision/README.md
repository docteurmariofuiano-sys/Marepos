...
Les **32 fiches biologiques** sont encodées dans un module **distinct, côté
...
Waldenström** (IgM monoclonale, hyperviscosité) et **myélome multiple**
(CRAB, composant monoclonal, pronostic). Le bloc hématologie s'appuie sur
