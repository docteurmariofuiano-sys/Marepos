...
Les **36 fiches biologiques** sont encodées dans un module **distinct, côté
...
Hte/Hb) et **thrombocytémie essentielle** (critères, thrombocytose
réactionnelle). Le bloc hématologie s'appuie sur
