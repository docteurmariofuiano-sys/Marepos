...
Les **39 fiches biologiques** sont encodées dans un module **distinct, côté
...
B/T, syndrome de lyse) et **LAM** (leucémie aiguë myéloïde : classification FAB,
MPO, corps d'Auer). Le bloc hématologie s'appuie sur
